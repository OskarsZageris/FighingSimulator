...
class TournamentTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testVikingVsSwordsman()
    {
        $swordsman = new Swordsman();
        $viking = new Viking();

        $viking->engage($swordsman);

        $this->assertEquals(0, $swordsman->hitPoints());
        $this->assertEquals(40, $viking->hitPoints());
    }
    ...
    public function testVikingWithBucklerVsSwordsmanWithBuckler()
    {
        $swordsman = (new Swordsman());
        $swordsman->equip("buckler");
        ...
        $this->assertEquals(0, $swordsman->hitPoints());
        $this->assertEquals(75, $viking->hitPoints());
    }
    ...
    public function testVikingVsArmoredSwordsman()
    {
        $highlander = new Highlander();
        $swordsman = (new Swordsman());
        $swordsman->equip("buckler");
        ...
        $this->assertEquals(0, $swordsman->hitPoints());
        $this->assertEquals(14, $highlander->hitPoints());
    }
